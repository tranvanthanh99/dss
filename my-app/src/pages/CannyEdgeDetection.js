  ...
  return (
    <React.Fragment>
      <ApplicationPageLayout backgroundClassName={classes.background}>
        <div>
          ...
          <Typography
            ...
            data-aos="fade-right"
          >
            Try Covid-19 Detection now by uploading a local image, or providing
            an image URL. 
          </Typography>
          <div>
            <Button
      ...
      <Typography
        ...
        data-aos="fade-in"
      >
        Try Covid-19 Detection now by uploading a local image, or providing an image URL.<br/>
This demo is built with Covid-19 API. If you have any specific technical requirements, check the index below or contact us.
      </Typography>
